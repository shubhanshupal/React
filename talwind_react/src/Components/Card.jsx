...
// function Card({product,product_type,price,img_src}){ // destructuring props object
function Card(props){
  ...
  return (
      ...
      <div className="flex-shrink-0 m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg">
        ...
        <div className="relative text-white px-6 pb-6 mt-6">
          <span className="block opacity-75 -mb-1">{props.product_type}</span>
          <div className="flex justify-between">
            <span className="block font-semibold text-xl">{props.product}</span>
